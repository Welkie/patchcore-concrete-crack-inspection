...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{results/visual_localization_surface_crack.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{results/visual_localization_sdnet2018_decks.jpg}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{results/visual_localization_deepcrack_cross-eval.jpg}
