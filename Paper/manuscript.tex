...
\multirow{4}{*}{Surface Crack} 
 ...
 & PatchCore & ResNet-50 & 10\%  & \textbf{0.9983} & 0.7862 & \textbf{0.9972} & 382.50& 49.12  \\
\midrule
\multirow{4}{*}{\makecell{SDNET2018\\(Decks)}} 
 ...
 & PatchCore & ResNet-18 & 10\%  & 0.8574 & 0.7811 & \textbf{0.9489} & 380.88& 44.18  \\
 & PatchCore & ResNet-50 & 10\%  & \textbf{0.8859} & 0.7393 & 0.9479 & 382.42& 49.20  \\
\midrule
...
Additionally, we analyze the spatial localization performance. Across all evaluated datasets, the ResNet-18 backbone consistently yields a higher pixel-level AUROC than the deeper ResNet-50. For example, on DeepCrack, PatchCore with ResNet-18 achieves a pixel-level AUROC of 0.9599, outperforming ResNet-50 which scores 0.9507. This indicates that the feature representations from intermediate layers of ResNet-18 retain finer spatial details, whereas ResNet-50 features undergo semantic compression, which slightly blurs localized patch boundaries during interpolation.
